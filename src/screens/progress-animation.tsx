...
const PercentageBar = ({ starText, percentage }: { starText: string; percentage: number; }) => {
      ...
      <View style={styles.reviewContainer}>
        ...
        <View style={{ marginTop: 40 }}>
          <View style={styles.spacer}>
            <PercentageBar starText="5 star" percentage={80} />
          </View>
          <View style={styles.spacer}>
            <PercentageBar starText="4 star" percentage={67} />
          </View>
          <View style={styles.spacer}>
            <PercentageBar starText="3 star" percentage={95} />
          </View>
          <View style={styles.spacer}>
            <PercentageBar starText="2 star" percentage={86} />
          </View>
          <View style={styles.spacer}>
            <PercentageBar starText="1 star" percentage={23} />
          </View>
        </View>
        <TouchableOpacity>
